...
# ---- shared processing logic (used by both polling and webhook modes) ---
def process_new_commit(latest_sha):
    """Run steps 2-6 of the pipeline for a given new commit SHA."""
